...
- `src/layouts/Layout.astro` — site layout & styles
- `.github/workflows/pages.yml` — GitHub Actions workflow to build and publish
...
tags: [home, site]
---
>>>>>>> e1e602e (feat(site): scaffold Astro + Svelte site, move content, add pages and GH Pages workflow)
